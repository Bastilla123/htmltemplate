...
//                        $this.find('span').html(start.format(drp.format) + drp.separator + end.format(drp.format));
    ...
    CMPLTADMIN_SETTINGS.cmpltadminWidgetWeather = function() {
        ...
        if($('.wid-weather-small .weekdays ul').length > 0){
            console.log("hi");
            const psweatherwidget = new PerfectScrollbar('.wid-weather-small .weekdays ul', {
                suppressScrollX: true
            });
        }
    ...
    CMPLTADMIN_SETTINGS.cmpltadminToDoAddTaskWidget = function() {
        ...
        $(".wid-add-task input").on('keypress', function(e) {
            if (e.keyCode == 13) {
                ...
                console.log($(this).parent().parent().find(".wid-all-tasks").attr("id"));
